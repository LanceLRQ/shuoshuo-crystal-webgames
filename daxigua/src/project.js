            ...
            p = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    this.canClick && (this.moreGameBtn.off(cc.Node.EventType.TOUCH_START, this.OnClickMoreGame, this), this.canClick = !1, this.moreGameBtn.runAction(cc.sequence(cc.scaleTo(.1, 1.1), cc.scaleTo(.1, 1))), this.scheduleOnce(function() {
                        window.location.href = "#"  // 更多
                    }, .15))
                }, t.prototype.GetContentByScore = function(e) {
                    var t = Math.ceil(e / 1500 * 94);
                    t > 94 && (t = 94);
                    var n = 5 + t;
                    return `击败了全球${  n  }%的水晶蟹！`, [`击败了全球${  n  }%的水晶蟹！`, `擊敗了全球${  n  }%的水晶蟹！`, `Beat ${  n  } % of global players`, `전 세계${  n  }% 의 유 저 를 이 겼 습 니 다`][i.default.returnCurrentLanType() - 1]
        ...
        var a = e("../common/PlayerInfo"),
            ...
            m = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    n.parent = this.lineNode, n.getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruit[e], n.children[0].getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruit[e], n.getComponent("fruitData").fruitNumber = e, n.position = this.lineNode.children[1].position, n.scale = 0, n.getComponent(cc.RigidBody).type = cc.RigidBodyType.Static, n.getComponent(cc.PhysicsCircleCollider).radius = 0, n.getComponent(cc.PhysicsCircleCollider).restitution =  (window.DIY_FRUIT_PHY_RESTITUTION || 0.1), n.getComponent(cc.PhysicsCircleCollider).apply(), cc.tween(n).to(.5, {
                        scale: 1,
                    }, {
                        easing: "backOut",
                    }).call(function() {
                    ...
                    o.parent = this.fruitNode, o.getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruit[e], o.children[0].getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruit[e], o.getComponent("fruitData").fruitNumber = e, o.position = t, o.scale = 0, o.getComponent(cc.RigidBody).linearVelocity = cc.v2(0, -100), o.getComponent(cc.PhysicsCircleCollider).radius = o.height / 2, o.getComponent(cc.PhysicsCircleCollider).restitution = (window.DIY_FRUIT_UP_PHY_RESTITUTION || 0.1), o.getComponent(cc.PhysicsCircleCollider).apply(), cc.tween(o).to(.5, {
                        scale: 1,
                    }, {
                        easing: "backOut",
                    }).call(function() {
            ...
            p = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    i.default.playerTouch && null != a.default.Instance.targetFruit && 1 == this.touchNum && (this.touchNum = 0, a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).radius = a.default.Instance.targetFruit.height / 2, a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).apply(), a.default.Instance.targetFruit.getComponent(cc.RigidBody).type = cc.RigidBodyType.Dynamic, a.default.Instance.targetFruit.getComponent(cc.RigidBody).linearVelocity = cc.v2(0, -800), a.default.Instance.targetFruit = null, this.scheduleOnce(function() {
                        // 水果生成
                        if (window.DIY_FRUIT_ONLY_LOW) {
                            i.default.GameUpdateCtrl && (a.default.Instance.createOneFruit(0), t.createFruitCount++)
                        } else {
            ...
            m = function(e) {
                ...
                return o(t, e), t.prototype.onLoad = function() {}, t.prototype.start = function() {
                    ...
                    if (this.node.x < -this.bianjieX && (this.node.x = -this.bianjieX), this.node.x > this.bianjieX && (this.node.x = this.bianjieX), this.notTargetTime += e, this.returnNumber && (this.scheduleOnce(function() {
                            t.getNumberTime = 0
                        }, .25), this.returnNumber = !1), "fruitNode" == this.node.parent.name && (this.testEndDJS += e), this.node.y + this.node.width / 2 > cc.find("Canvas/lineNode").children[0].y && 0 == this.pengzhuangCount && this.endCtrl && 0 == this.endOne && this.testEndDJS > 3 && !window.DIY_WHOSYOURDADDY) {
                    ...
                    var o = this;
                    if (i.default.Instance != null && (t.node._id == (i.default.Instance.targetFruit||{})._id || n.node._id == (i.default.Instance.targetFruit||{})._id)) return;
        ...
        cc.Class({
            ...
            getContentByScore: function(e, t) {
                ...
                if (e > 0 && e <= o) n = `我在${  t  }中得了${  e  }分，真是太棒了，再练练就能达到游刃有余的境界！`;
                    ...
                    n = `我在${  t  }中得了${  e  }分，击败了全球${  Math.floor(12 * (e - this.standardScore) / (c - this.standardScore)) + 80  }%的水晶蟹，进入了信手拈来的境界！`
                } else if (e > c && e <= a) {
                    n = `我在${  t  }中得了${  e  }分，击败了全球${  Math.floor(7 * (e - c) / (a - c)) + 92  }%的水晶蟹，进入了运用自如的境界！`
                } else if (e > a && e <= i) n = `我在${  t  }中得了${  e  }分，击败了全球99%的水晶蟹，达到了行云流水的境界！`;
